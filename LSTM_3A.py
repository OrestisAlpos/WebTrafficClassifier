...
model.add(LSTM(units=40, recurrent_initializer='uniform', kernel_initializer='uniform', activation='relu', stateful=True, return_sequences=True))
model.add(LSTM(units=30, recurrent_initializer='uniform', kernel_initializer='uniform', activation='relu', stateful=True))
model.add(Dense(1, kernel_initializer='uniform', activation = 'sigmoid'))


model.summary()
plot_model(model, to_file='./LSTMmodels/LSTM_3A.png', show_shapes=True)
fp = open('./LSTMmodels/LSTM_3A.json', 'w')
